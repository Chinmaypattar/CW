...
interface TimerModalProps {
  isOpen: boolean;
  onClose: () => void;
  timer?: Timer; // Optional: If provided, modal will act as an edit modal
  onUpdate?:(timerSeconds:number)=> void
}

export const TimerModal: React.FC<TimerModalProps> = ({ isOpen, onClose, timer,onUpdate }) => {
  ...
  return (
    <div data-testid ={`dialog`}  className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <Button label={timer ? 'Save Changes' : 'Add Timer'} type='submit' variant='primary' />
